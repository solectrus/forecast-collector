Config = Struct.new(
  :forecast_interval, :forecast_latitude, :forecast_longitude, :forecast_declination, :forecast_azimuth, :forecast_kwp,
  :influx_schema, :influx_host, :influx_port, :influx_token, :influx_org, :influx_bucket,
  keyword_init: true
) do
